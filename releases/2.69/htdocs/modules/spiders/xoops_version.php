...
$modversion['releasedate'] = "Tuesday: May 03, 2011";
...
$modversion['config'][$i]['valuetype'] = 'text';
$modversion['config'][$i]['default'] = 'Mozilla/5.0|Mozilla/4.0|Mozilla/3.0|Mozilla/3.01|Mozilla/2.0|Mozilla|mozilla|Windows|Unix|Linux|OS|Mac';
