...
// ------------------------------------------------------------------------- //
	...
	define('_AM_SPIDERS_FILEDESC', 'If you wish to get another copy of supported files please goto <a href="http://www.spiders.com/robotstxt,0,18.html">www.spiders.com</a>');
	define('_AM_SPIDERS_IMPORTAPI', 'Select API Data file to Import');
	define('_AM_SPIDERS_IMPORTAPIDESC', 'If you wish to link with the api signup at <a href="http://www.spiders.com/robotstxt,0,18.html">www.spiders.com</a>');
	...
	define('_AM_SPIDERS_API_CURL', 'cURL JSON Method');
	define('_AM_SPIDERS_API_JSON', 'wGET JSON Method');
	...
	// Version 2.68
	define('_AM_SPIDERS_API_CURLSERIALISED', 'cURL Serialised Method');
	define('_AM_SPIDERS_API_CURLXML', 'cURL XML Method');
	define('_AM_SPIDERS_API_WGETSERIALISED', 'wGET Serialised Method');
	define('_AM_SPIDERS_API_WGETXML', 'wGET XML Method');
	
	// Version 2.76
	// Dashboard
	define('_AM_SPIDERS_ADMIN_COUNTS', 'Robots Basic Statistics');
	define('_AM_SPIDERS_ADMIN_THEREARE_BOTSACTIVE', 'Number in DB Active: %s');
	define('_AM_SPIDERS_ADMIN_THEREARE_BOTSINACTIVE', 'Number in DB Inactive: %s');
	define('_AM_SPIDERS_ADMIN_THEREARE_BOTLASTLOGGEDON', 'Last Logged On: %s');
	define('_AM_SPIDERS_ADMIN_THEREARE_BOTINMONTH', 'Robots Upto One Month Logged In: %s');
	define('_AM_SPIDERS_ADMIN_THEREARE_BOTIN6MONTH', 'Robots Over One Month to Six Months Logged In: %s');
	define('_AM_SPIDERS_ROBOTS_COUNTS', '%s Spider/Robot Overview');
	define('_AM_SPIDERS_ROBOTS_THEREARE_PERCENTAGEOFHITS', 'Percentage of Activity: %s');
	define('_AM_SPIDERS_ROBOTS_THEREARE_NUMBEROFHITS', 'Number of Crawl: %s');
	define('_AM_SPIDERS_ROBOTS_THEREARE_LASTHIT', 'Last Crawl: %s');
	define('_AM_SPIDERS_ROBOTS_THEREARE_LASTURI', 'Last URL Crawled: %s');
	define('_AM_SPIDERS_ROBOTS_THEREARE_FIRSTHIT', 'First Crawled: %s');
	define('_AM_SPIDERS_ROBOTS_THEREARE_FIRSTURI', 'First URL Crawled: %s');
	
	// About
	define('_AM_SPIDERS_ABOUT_MAKEDONATE', 'Make donations to chronolabs co-op!');
?>