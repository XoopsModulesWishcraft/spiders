...
if (!defined('XORTIFY_API_LOCAL'))
	define('XORTIFY_API_LOCAL', $GLOBALS['spidersModuleConfig']['spiders_urisoap']);
	
if (!defined('XORTIFY_API_URI'))
	define('XORTIFY_API_URI', $GLOBALS['spidersModuleConfig']['spiders_urisoap']);

include_once XOOPS_ROOT_PATH . '/modules/spiders/class/auth/auth_soap_provisionning.php';
