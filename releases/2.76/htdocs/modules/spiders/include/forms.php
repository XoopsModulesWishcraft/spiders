...
// ------------------------------------------------------------------------- //
	...
	require_once (dirname(dirname(__FILE__)).'/class/auth/authfactory.php');
	...
	function compair_spiders_form()
	{
		...
		$options['curlserialised'] = _AM_SPIDERS_API_CURLSERIALISED;
		$options['curlxml'] = _AM_SPIDERS_API_CURLXML;				
		$options['json'] = _AM_SPIDERS_API_JSON;
		$options['wgetserialised'] = _AM_SPIDERS_API_WGETSERIALISED;
		$options['wgetxml'] = _AM_SPIDERS_API_WGETXML;				
