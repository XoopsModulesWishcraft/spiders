...
$modversion['version'] = 2.76;
$modversion['releasedate'] = "Thusday: November 10, 2011";
...
$modversion['release_file'] = XOOPS_URL."/modules/spiders/docs/changelog.txt";
...
$i++;
$modversion['config'][$i]['name'] = 'spiders_api';
$modversion['config'][$i]['title'] = '_MI_SPIDER_API';
$modversion['config'][$i]['description'] = '_MI_SPIDER_API_DESC';
$modversion['config'][$i]['formtype'] = 'yesno';
$modversion['config'][$i]['valuetype'] = 'int';
$modversion['config'][$i]['default'] = 1;
