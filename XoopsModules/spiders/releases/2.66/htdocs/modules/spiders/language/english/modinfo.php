...
// ------------------------------------------------------------------------- //
	...
	define('_MI_SPIDERS_PROTOCOL_DESC', 'This is the protocol that is used in the communication with the xortify cloud!');
	define('_MI_SPIDERS_PROTOCOL_SOAP', 'SOAP Protocol');
	define('_MI_SPIDERS_PROTOCOL_CURL', 'CURL Protocol');
	define('_MI_SPIDERS_PROTOCOL_JSON', 'Open Access Protocol');
