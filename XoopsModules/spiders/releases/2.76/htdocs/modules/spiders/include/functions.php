...
if (!function_exists("spiders_adminMenu")) {
  function spiders_adminMenu ($page, $currentoption = 0)  {
  		global $xoopsConfig;
		$module_handler =& xoops_gethandler('module');
		$GLOBALS['spidersModule'] = $module_handler->getByDirname(_MI_SPIDERS_DIRNAME);
	...
	#buttonbar a:hover span { background-position:100% -150px; }
		...
		// $adminmenu=array();
	   	...
	   	echo "<td style=\"width: 45%; font-size: 10px; text-align: left; color: #2F5376; padding: 0 6px; line-height: 18px;\"><!--<a class=\"nobutton\" href=\"".XOOPS_URL."/modules/system/admin.php?fct=preferences&amp;op=showmod&amp;mod=" . $GLOBALS['spidersModule']->getVar('mid') . "\">" . _PREFERENCES . "</a>--></td>";
	   	echo "<td style='font-size: 10px; text-align: right; color: #2F5376; padding: 0 6px; line-height: 18px;'><b>" . $myts->displayTarea($GLOBALS['spidersModule']->name()) ."</td>";
	   	echo "</tr></table>";
	   	echo "</div>";
	   	echo "<div id='buttonbar'>";
	   	echo "<ul>";
		foreach ($GLOBALS['spidersModule']->getAdminMenu() as $key => $value) {
		   	$tblColors[$key] = '';
		   	$tblColors[$currentoption] = 'current';
	    	echo "<li id='" . $tblColors[$key] . "'><a href=\"" . XOOPS_URL . "/modules/".$GLOBALS['spidersModule']->getVar('dirname')."/".$value['link']."\"><span>" . $value['title'] . "</span></a></li>";
		}
  ...
  function footer_spiders_adminMenu()
  {
...
if (!function_exists('import_robotstxt_org')){
